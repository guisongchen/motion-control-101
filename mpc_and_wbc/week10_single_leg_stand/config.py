...
DIRECT_SINGLE_SUPPORT_SUPPORT_ARM_SHOULDER_PITCH = -1.2
DIRECT_SINGLE_SUPPORT_SUPPORT_ARM_SHOULDER_ROLL = 0.3
DIRECT_SINGLE_SUPPORT_SUPPORT_ARM_ELBOW = 0.8
...
DIRECT_SINGLE_SUPPORT_SUPPORT_BLEND = 0.705
DIRECT_SINGLE_SUPPORT_WBC_CONTACT_POINT = "corner_patch"
DIRECT_SINGLE_SUPPORT_COP_TARGET = "initial_contact"
DIRECT_SINGLE_SUPPORT_COP_MARGIN = 0.005
DIRECT_SINGLE_SUPPORT_COP_FEEDBACK_ENABLED = True
DIRECT_SINGLE_SUPPORT_COP_FEEDBACK_FILTER_ALPHA = 0.1
DIRECT_SINGLE_SUPPORT_COP_FEEDBACK_KP = 0.035
DIRECT_SINGLE_SUPPORT_COP_FEEDBACK_KD = 0.0
DIRECT_SINGLE_SUPPORT_COP_FEEDBACK_MAX_OFFSET = 0.003
DIRECT_SINGLE_SUPPORT_USE_WRENCH_OBJECTIVE = True
DIRECT_SINGLE_SUPPORT_WRENCH_STATE_FILTER_ALPHA = 0.1
DIRECT_SINGLE_SUPPORT_WRENCH_SLIP_FORCE_KP = 600.0
DIRECT_SINGLE_SUPPORT_WRENCH_SLIP_FORCE_KD = 20.0
DIRECT_SINGLE_SUPPORT_WRENCH_SLIP_FORCE_MAX = 20.0
DIRECT_SINGLE_SUPPORT_WRENCH_YAW_MOMENT_KP = 8.0
DIRECT_SINGLE_SUPPORT_WRENCH_YAW_MOMENT_KD = 1.0
DIRECT_SINGLE_SUPPORT_WRENCH_YAW_MOMENT_MAX = 4.0
DIRECT_SINGLE_SUPPORT_WRENCH_FORCE_XY_WEIGHT = 0.03
DIRECT_SINGLE_SUPPORT_WRENCH_FORCE_Z_WEIGHT = 0.0
DIRECT_SINGLE_SUPPORT_WRENCH_MOMENT_WEIGHT = 5.0
DIRECT_SINGLE_SUPPORT_WRENCH_YAW_MOMENT_WEIGHT = 1.0
