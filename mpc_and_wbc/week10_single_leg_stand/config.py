...
PRE_LIFTOFF_EXTRA_ROLL_DELTA = 0.005
PRE_LIFTOFF_EXTRA_SWING_PROGRESS = 0.10
PRE_LIFTOFF_SWING_KP_SCALE = 0.60
PRE_LIFTOFF_SWING_KD_SCALE = 0.75
LOAD_SHIFT_SUPPORT_RATIO = 0.53
PRE_LIFTOFF_SUPPORT_RATIO = 0.60
LOAD_SHIFT_COM_RATIO = 0.20
PRE_LIFTOFF_COM_RATIO = 0.28
